const Groups = {
    ...
    // --- שוחזר: לוגיקת יבוא קבוצות משנה קודמת ---
    ...
    exportGroupData(format) {
        ...
        Reports.getAllHistory().then(historyData => {
            ...
            if (format === 'excel') {
                ...
                // פונט בסיסי לתמיכה בעברית (חלקי) או אנגלית
    ...
    async printSheet(type) {
        ...
        if(type === 'members') {
            ...
            html += `<table class="print-table"><thead><tr><th>#</th><th>שם הבחור</th><th>שיעור</th></tr></thead><tbody>`;
            let count = 0;
